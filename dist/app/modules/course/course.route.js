...
router.put('/api/courses/:courseId', (0, auth_1.default)('admin'), (0, validateRequest_1.default)(course_validation_1.courseValidation.courseUpdateValidationSchema), course_controller_1.CourseControllers.updateCourse);
